javascript: !(function () {
    ...
    function h(e) {
        ...
        (o.style.cssText =
            ...
            document.body.appendChild(o),
            (document.getElementById("abrirDoc").onclick = function () {
                try {
                    window.open(e, "_blank", "width=1200,height=800"),
                        (this.textContent = "✓ Documento Aberto"),
                        (this.style.background = "#007cba");
            ...
            (document.getElementById("resumirTexto").onclick = function () {
                var e = document.getElementById("conteudoTexto").value.trim(),
                    t = document.getElementById("tipoResumo").value;
                e
                    ? (document.body.removeChild(o), a(e, t))
                    : alert("Cole o conteúdo do documento primeiro.");
            });
    }
    function d(e, o) {
        var t = {
